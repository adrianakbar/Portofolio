          ...
          <div className="mt-50">
            <div className="flex items-center gap-2">
              ...
              <RotatingText
                ...
                mainClassName="font-boldonse px-2 sm:px-2 md:px-3 bg-[#292929] text-white overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg text-xl font-bold inline-flex transition-all"
                staggerFrom={"last"}
                initial={{ y: "100%" }}
                animate={{ y: 0 }}
                exit={{ y: "-120%" }}
            ...
            <div>
              <h1 className="text-lg mt-5">
                ...
                Information Technology student at Universitas Jember with a
